...
public class AdminMediaController {
    ...
    public AdminMediaController(MediaAssetService media, MediaOrphanReportService orphans) {
        this.media = media;
    ...
    PageResponse<MediaAssetSummary> list(
        ...
        return PageResponse.from(media.list(PageRequest.of(validPage(page), validSize(size))));
    }

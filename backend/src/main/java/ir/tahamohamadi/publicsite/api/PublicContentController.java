...
public class PublicContentController {
    ...
    @GetMapping("/portfolio") ResponseEntity<?> projects(@PathVariable LanguageCode lang,@RequestParam(required=false) String skill,@RequestParam(defaultValue="0") @Min(0) @Max(42_949_672) int page,@RequestParam(defaultValue="20") @Min(1) @Max(50) int size){return cached(content.projects(lang,skill,page,size));}

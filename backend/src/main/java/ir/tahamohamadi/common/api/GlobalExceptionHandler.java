...
record TranslationUnavailableError(Instant timestamp,int status,String code,String message,String path,List<String> availableLocales,List<String> alternatePaths) { }

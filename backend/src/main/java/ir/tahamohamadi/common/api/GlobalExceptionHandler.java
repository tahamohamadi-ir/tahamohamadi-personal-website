...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(MediaUploadException.class) ResponseEntity<ApiErrorResponse> media(MediaUploadException e,HttpServletRequest r) { return response(HttpStatus.UNSUPPORTED_MEDIA_TYPE,"UNSUPPORTED_MEDIA","Uploaded file was rejected",r,List.of()); }

...
public class PublicContactController {
    ...
    @PostMapping ResponseEntity<ContactSubmissionResponse> submit(@Valid @RequestBody ContactSubmissionRequest request,HttpServletRequest http){return ResponseEntity.status(HttpStatus.ACCEPTED).body(contacts.submit(request,http.getRemoteAddr()));}
}

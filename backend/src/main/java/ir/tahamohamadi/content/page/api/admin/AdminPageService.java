...
public class AdminPageService {
    ...
    @Transactional public void delete(UUID id,long version) { ContentPage page=page(id); version(page,version); page.softDelete(null,Instant.now()); record("ADMIN_PAGE_DELETED",id); }

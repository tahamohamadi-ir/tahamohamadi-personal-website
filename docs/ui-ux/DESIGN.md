...
- Markdown/rich-content architecture and contract are approved (UX-DEC-011); RC-001 is complete, while renderer implementation remains gated by RC-002 through RC-005.

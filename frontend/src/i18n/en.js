export default {
  ...
  admin: {
    ...
    portfolio: {
      ...
      discard: 'Discard unsaved portfolio changes?', conflict: 'This project changed elsewhere. Reload it before saving.', key: 'Project key', startDate: 'Start date', endDate: 'End date', projectUrl: 'Project URL', repositoryUrl: 'Repository URL', sortOrder: 'Sort order', coverMedia: 'Cover media', associatedSkills: 'Associated skills',
    ...
    navigationItems: { dashboard: 'Dashboard', siteSettings: 'Site settings', navigation: 'Navigation', pages: 'Pages', blogPosts: 'Blog posts', blogCategories: 'Blog categories', blogTags: 'Blog tags', resume: 'Resume', publications: 'Publications', portfolio: 'Portfolio', skills: 'Skills', media: 'Media', socialLinks: 'Social links', featured: 'Featured content', contactMessages: 'Contact messages' },
    siteSettings: {
      title: 'Site settings', description: 'Controlled public identity and presentation options. Custom CSS is not supported.',
    ...
    composer: {
      title: 'Page composer', description: 'Approved blocks only. Each translation remains independent.', add: 'Add block', preview: 'Preview composition', previewTitle: 'Composition preview', closePreview: 'Close composition preview', save: 'Save composition', reload: 'Reload blocks',

export default {
  ...
  admin: {
    ...
    composer: {
      ...
      empty: 'No blocks yet. Add a block to compose this page.', type: 'Block type', visible: 'Visible', media: 'Media asset', decorativeMedia: 'Decorative image (no alt text)', collection: 'Collection', limit: 'Items to show',
